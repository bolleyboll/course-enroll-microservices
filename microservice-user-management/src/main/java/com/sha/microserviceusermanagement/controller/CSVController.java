...
import com.sha.microserviceusermanagement.service.CSVService;
//import com.bezkoder.spring.files.csv.helper.CSVHelper;
import com.sha.microserviceusermanagement.message.ResponseMessage;


@CrossOrigin
@Controller
@RequestMapping("/service/csv")
public class CSVController {
    ...
    @GetMapping("/grades")
    public ResponseEntity<List<Grade>> getAllTutorials() {
        try {
            List<Grade> grades = fileService.getAllTutorials();
    ...
    public ResponseEntity<Resource> getFile() {
        String filename = "gradefile1.csv";
